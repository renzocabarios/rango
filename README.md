...
- [Controllers](example/controllers/README.md#controllers)
  - [Basic Usage](example/controllers/README.md#basic-usage)
  - [Controller Object](example/controllers/README.md#controller-object)
  - [Controller File](example/controllers/README.md#controller-file)
  - [Controller.get](example/controllers/README.md#controller-get)
  - [Controller.post](example/controllers/README.md#controller-post)
  - [Controller.put](example/controllers/README.md#controller-put)
  - [Controller.patch](example/controllers/README.md#controller-patch)
  - [Controller.delete](example/controllers/README.md#controller-delete)
  - [Controller.head](example/controllers/README.md#controller-head)
  - [Controller.options](example/controllers/README.md#controller-options)
  - [Controller Method Options](example/controllers/README.md#controller-method-options)
  - [Multiple Controllers](example/controllers/README.md#multiple-controllers)
  - [Controllers with Basic Routing](example/controllers/README.md#controllers-with-basic-routing)
  - [Controllers Project](example/controllers/README.md#controllers-project)
...
- [Examples](example/README.md#api-references)
  - [Basic Authentication](example/README.md#basic-authentication)
  - [Todo](example/README.md#todo)
  - [RangoJS with Jest](example/README.md#rangojs-jest)
