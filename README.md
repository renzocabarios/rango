...
- [Controllers](example/controllers/README.md)
  - [Basic Usage](example/controllers/basic-controller/README.md)
  - [Creating a Controller](example/controllers/README.md#creating-a-controller)
  - [Controller.get](example/controllers/README.md#get)
  - [Controller.post](example/controllers/README.md#post)
  - [Controller.put](example/controllers/README.md#put)
  - [Controller.patch](example/controllers/README.md#patch)
  - [Controller.delete](example/controllers/README.md#delete)
  - [Controller.head](example/controllers/README.md#head)
  - [Controller.options](example/controllers/README.md#options)
  - [Basic Controller Routing](example/controllers/basic-controller-routing/README.md)
  - [Multiple Controllers](example/controllers/multiple-controllers/README.md)
  - [Multiple Controllers with Simple Routes](example/controllers/multiple-controllers-with-simple-routes/README.md)
  - [Advance Controller Routing](example/controllers/routing-controller-advance/README.md)
...
- [Examples](example/README.md#api-references)
  - [Basic Authentication](example/advance/basic-authentication/README.md)
  - [Todo](example/advance/todo/README.md)
  - [RangoJS with Jest](example/advance/jest-sample/README.md)
  - [Mongodb CRUD](example/advance/crud-mongodb/README.md)
  - [MySQL CRUD](example/advance/crud-mongodb/README.md)
